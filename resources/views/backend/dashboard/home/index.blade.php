        ...
        <div class="col-lg-4">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content ibox-heading">
                    ...
                    <small><i class="fa fa-tim"></i> You have 22
                        new messages and 16 waiting in draft
                        folder.</small>
                </div>
                <div class="ibox-content">
                    <div class="feed-activity-list">
                        <div class="feed-element">
                            <div>
                                ...
                                <small class="text-muted">Today 5:60 pm -
                                    12.06.2014</small>
                            </div>
                        </div>
                        ...
                        <div class="feed-element">
                            <div>
                                ...
                                <small class="text-muted">Today 2:23 pm -
                                    11.06.2014</small>
                            </div>
                        </div>
                        ...
                        <div class="feed-element">
                            <div>
                                ...
                                <small class="text-muted">Today 1:00 pm -
                                    08.06.2014</small>
                            </div>
                        </div>
                        ...
                        <div class="ibox-content">
                            <ul class="todo-list m-t small-list">
                                ...
                                <li>
                                    ...
                                    <span class="m-l-xs">Go to shop and find
                                        some products.</span>
                                </li>
                                <li>
                                    <a href="#" class="check-link"><i class="fa fa-square-o"></i>
                                    </a>
                                    <span class="m-l-xs">Send documents to
                                        Mike</span>
                                ...
                                <li>
                                    ...
                                    <span class="m-l-xs">Go to the doctor dr
                                        Smith</span>
                                </li>
                                <li>
                                    <a href="#" class="check-link"><i class="fa fa-check-square"></i>
                                ...
                                <li>
                                    ...
                                    <span class="m-l-xs">Call to Anna for
                                        dinner</span>
                                </li>
                            </ul>
                        </div>
